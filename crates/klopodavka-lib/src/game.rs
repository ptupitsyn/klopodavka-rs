...
mod tests {
    ...
    #[test]
    fn deserialize_new_game_from_ui_returns_empty_game() {
        let ser = r"30x30,6/6,Red
······························
······························
···························L··
······························
...
······························";
        ...
        let game = GameState::deserialize(ser.to_string());
        let empty_game = GameState::new();

        assert_eq!(game, empty_game);
    }
}
